...
def run_tool_round(
    ...
    truncated_tool_call_retries: Any, requested_output_cap: Any,
) -> ToolRoundVerdict:
    ...
    _tvv = validate_tool_calls(
        ...
        effective_task_id=effective_task_id, requested_output_cap=requested_output_cap,
