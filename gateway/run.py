...
class GatewayRunner(
    ...
    def _set_session_env(self, context: SessionContext, *, message_id: Optional[str] = None) -> list:
        ...
        effective_message_id = message_id if message_id is not None else context.source.message_id
